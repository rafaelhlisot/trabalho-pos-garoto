    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: ScaffoldMessenger(
          ...
          appBar: CustomAppBar(
            title: 'Task Manager',
            centerTitle: true,
            onBackTap: () => {Navigator.pushNamed(context, Pages.about)},
            showBackArrow: false,
            actionWidgets: [
              PopupMenuButton<int>(
                ...
                itemBuilder: (BuildContext context) {
                  return [
                    PopupMenuItem<int>(
                      value: 1,
                      onTap: () => {SortTaskEvent(sortOption: 0)},
                      child: Row(
                        children: [
                          SvgPicture.asset(
                    ...
                    PopupMenuItem<int>(
                      value: 2,
                      onTap: () => {SortTaskEvent(sortOption: 1)},
                      child: Row(
                        children: [
                          SvgPicture.asset(
                    ...
                    PopupMenuItem<int>(
                      value: 3,
                      onTap: () => {SortTaskEvent(sortOption: 2)},
                      child: Row(
                        children: [
                          SvgPicture.asset(
